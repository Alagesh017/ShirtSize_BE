...
def extract_keypoints(image_file):
    ...
    return [(l.y, l.x) for l in results.pose_landmarks.landmark], image_height, image_width


def calculate_distance(p1, p2, image_width, image_height):
    """Calculate pixel distance between two keypoints."""
...
@measurement_bp.route('/measurement1', methods=['POST'])
def upload_image1():
    try:
...
@measurement_bp.route('/measurement2', methods=['POST'])
